...
%>
          ...
          <th scope="col"><a href="myCart.jsp"><i class='fas fa-arrow-circle-left'> Back</i></a></th>
            <th scope="col" style="background-color: yellow;">Total: <i class="fa fa-inr"><%out.println(); %></i></th>
          </tr>
        </thead>
        <thead>
          <tr>
...
<input class="input-style"type="text" name="transactionalId"  placeholder="Enter Transaction Id">
