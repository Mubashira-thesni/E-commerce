...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
    ...
    <div class="topnav sticky">
           <%String email=session.getAttribute("email").toString(); %>
            ...
            <a href="messageReceived">Messages Received <i class='fas fa-comment-alt'></i></a>
            <a href="orderRecieved.jsp">Orders Received <i class="fas fa-archive"></i></a>
            <a href="cancelOrders">Cancel Orders <i class='fas fa-window-close'></i></a>
            <a href="deliveredOrders">Delivered Orders <i class='fas fa-dolly'></i></a>
