...
<hr>
<textarea class=input-style" name="body" type="text" placeholder="your message" required></textarea>
<hr>
<button class="button" type="submit">Send<i class="far-arrow-alt-circle-right"></i></button>
</form>
<br><br><br>
</body>
</html>